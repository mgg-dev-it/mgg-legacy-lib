...
//            return;
        ...
        if (c != null && (c.equals(java.lang.Short.class) || c.equals(java.lang.Integer.class) || c.equals(java.lang.Long.class) || c.equals(java.lang.Double.class) || c.equals(java.lang.Float.class))) {
            ...
            if (value != null) {
                if (sSpecType.equals("timesheet_time_time")) {
                    ...
                    //setText(swingAppInterface.getDecimalFormat().format(value)); //a formattált számban lévő szóköz invalid karakter (beep) hibát okozott
                    //System.out.println(value.toString());
                    setText(swingAppInterface.getDecimalFormat().format(value).replace(" ", "")); //a formattált számban lévő szóköz invalid karakter (beep) hibát okozott
        ...
        if (c != null && c.equals(java.math.BigDecimal.class)) {
            ...
            if (value != null) {
                //setText(swingAppInterface.getDecimalFormat(iDecimals).format(value)); //a formattált számban lévő szóköz invalid karakter (beep) hibát okozott
                String sTmp = swingAppInterface.getDecimalFormat(iDecimals).format(value).replace(" ", "");
                if (sTmp.endsWith(".")) {
                    sTmp = sTmp.substring(0, sTmp.length() - 1);
                }
                setText(sTmp); //a formattált számban lévő szóköz invalid karakter (beep) hibát okozott, és a végén lévő tizedespont is
                //setText(swingAppInterface.getDecimalFormat(iDecimals).format(value).replace(" ", "")); //a formattált számban lévő szóköz invalid karakter (beep) hibát okozott
                //setText(value.toString());
            }
            color();
            fireMagComponentEventChanged();
    ...
    public boolean isChanged() {
        ...
        if (c.equals(java.sql.Timestamp.class)) { //t�rt m�sodperceket nem ellen�rzi!!!
