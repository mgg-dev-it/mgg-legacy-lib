...
public class FormatDialog extends JDialog implements ActionListener, KeyListener {
    ...
    private void init() {
        ...
        sXMLConfig += "        </languageitem>";
        sXMLConfig += "        <languageitem key='FormatDialog Mentés'>";
        ...
        sDatePartOrderLookup += "yyyy-MM-dd|" + swingAppInterface.getLanguageString("FormatDialog Év") + " " + swingAppInterface.getLanguageString("FormatDialog Hónap") + " " + swingAppInterface.getLanguageString("FormatDialog Nap");
        sDatePartOrderLookup += "@";
        sDatePartOrderLookup += "dd-MM-yyyy|" + swingAppInterface.getLanguageString("FormatDialog Nap") + " " + swingAppInterface.getLanguageString("FormatDialog Hónap") + " " + swingAppInterface.getLanguageString("FormatDialog Év");
        sDatePartOrderLookup += "@";
        sDatePartOrderLookup += "MM-dd-yyyy|" + swingAppInterface.getLanguageString("FormatDialog Hónap") + " " + swingAppInterface.getLanguageString("FormatDialog Nap") + " " + swingAppInterface.getLanguageString("FormatDialog Év");
