...
public class PreviewVirtualDrawSurface extends CommonPanel implements ActionListener, ChangeListener
{
    ...
    public PreviewVirtualDrawSurface(SwingApp app, PageFormat pageFormat, Dimension dimPreferred)
    {
        ...
        addToGrid(jRadioButtonLandscape = AppUtils.createRadioButton("Fekvő", "Landscape", this), 1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NONE);
...
//    }
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        //r�gen ez volt: PrintUtilities.printComponent(printablePages, pageFormat,dPrintSizeRatio);
        printReport();
        }*/
    ...
    //meg kell val�s�tani VDS-hez is!
    ...
    //System.err.println(printerDialog.showDialog(this, "Nyomtat� kiv�laszt�s", ""));
