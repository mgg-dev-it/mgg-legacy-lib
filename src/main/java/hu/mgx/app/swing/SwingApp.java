...
//    private String sPrintPreviewTitle = "Nyomtatási elõkép";
...
//        progressDisplay.showDialog(jFrame, "Kilépés", "Elõkészítés");
...
//    }
    ...
    public JInternalFrame addInternalFrame(JInternalFrame f, String sActionCommand) {
        ...
        //@todo a már nem használt helyeket töltse fel a program, különben a végén minden form a képernyõ alján lesz!!!
...
//    }
    ...
    public void setWindowMenu(JMenu m, ActionListener l) {
        ...
        iWindowMenuItemCount = 0; //windowMenu.getItemCount(); //@@@todo 1-tõl induljon ... !!!
    }
...
//        }
    ...
    public void initXML(AppInterface appInterface, String sXMLConfig, String sEncoding, ActionListener actionListener) {
        ...
        iWindowMenuItemCount = 0; // windowMenu.getItemCount(); //MAG 2014.07.22. setWindowMenu(...) túl korán hívja meg
        if (this.sDateTimeVersion.equals(DEVELOPER_VERSION)) {
            ...
            sXMLDeveloper += "            <translation lang='hu'>_Fejlesztõ</translation>";
            ...
            sXMLDeveloper += "            <translation lang='hu'>Képernyõmentés</translation>";
