...
public class ReportSection
{
    ...
    //--- VirtualDrawSurface-ből másolva ---
    ...
    private String getCellContent(Cell cell, MemoryTable memoryTable, int row)
    {
        String sRetVal = "";
        String sCellNames[];
        //--- egyszerű cella tartalmának meghatározása ---
            ...
            if (iBlock < 2)
            {
                ...
                for (int i = iCellFrom; i < iCellTo; i++)
                {
                    ...
                    if (cell.isStretched() && g2d != null)
                    {
                        ...
                        //--- a többi (hátralévö) cellákat el kell tolni a magasságdifferenciával és a szekció magasságát is ehhez kell igazítani ---
                        }
