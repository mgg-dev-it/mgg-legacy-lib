...
public class CommonTextField extends JTextField implements DataField
{
    ...
    public Object getValue()
    {
        ...
        if (fieldDefinition.getType() == FieldType.INT)
        {
            ...
            try
            {
                i = Integer.parseInt(hu.mgx.util.StringUtils.stringReplace(getText(), sGroupingSeparator, "")); //@todo filter funkció kellene, amelyik csak a számokat, előjelet és a tizedespontot engedi át...
            }
        ...
        if (fieldDefinition.getType() == FieldType.DECIMAL)
        {
            ...
            try
            {
                d = Double.parseDouble(hu.mgx.util.StringUtils.stringReplace(getText(), sGroupingSeparator, "")); //@todo filter funkció kellene, amelyik csak a számokat, előjelet és a tizedespontot engedi át...
            }
            catch (NumberFormatException e)
            {
                d = 0.0;
