...
//        }
        if (bMax)
        {
            ...
            {
                JOptionPane.showMessageDialog(null, StringUtils.stringReplace(appInterface.getLanguageString("Több, mint XXX rekordot választott ki, de megjeleníteni csak ennyit lehet. Szűkítse a kiválasztandókat a szelekcióval!"), "XXX", Integer.toString(iMaxRecords)), appInterface.getLanguageString("Figyelem!"), JOptionPane.WARNING_MESSAGE);
            }
            else
            {
                JOptionPane.showMessageDialog(null, "T�bb, mint " + Integer.toString(iMaxRecords) + " rekordot választott ki, de megjeleníteni csak ennyit lehet. Szűkítse a kiválasztandókat a szelekcióval!", "Figyelem!", JOptionPane.WARNING_MESSAGE);
            }
        }
    }
