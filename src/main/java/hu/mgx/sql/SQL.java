        ...
        for (int i = 0; i
            ...
            try {
                if (td.getFieldDefinition(i).isFilter()) {
                    ...
                    sWhere +=
                            td.getFieldDefinition(i).getFilter(); //@todo típus szerint kellen esetleg aposztróf, de ezt most a filterbe kell tenni
                }
    ...
    public boolean insert(TableDefinition td, Record record, int iLogLevel) {
        ...
        for (int i = 0; i
            ...
            try {
                ...
                // Ha egy ID mezõ kulcs is, akkor nem ellenõrizhetünk duplikáltságot, mert az ID definíciójából következõen mindíg új értéket kap.
                if (td.getFieldDefinition(i).isID() && td.getFieldDefinition(i).isKey()) {
                    bIDKey = true;
                }
                // ID mezõt nem szúrunk be ... bár késõbb lekérdezzük: lásd getLastInsertedID() !!!
                // Ha nem ID mezõ, akkor hozzáadjuk a mezõlistához, az érték listához, valamint ha kulcs, akkor a where-listához is
                if (!td.getFieldDefinition(i).isID()) {
        ...
        try {
            ...
            if (!bIDKey && bHasKey) {
                ...
                if (rs.next()) {
                    ...
                    bSuccess =
                            false;
                    appInterface.handleError("Létezõ rekord, nem lehet beszúrni!");
                } else {
    ...
    public boolean update(TableDefinition td, Record oldRecord, Record newRecord, int iLogLevel) {
        ...
        for (int i = 0; i
            ...
            try {
                ...
                if (!equal(oOld, oNew, td.getFieldDefinition(i).getType())) { // Mezõ értéke megváltozott
                    sOldClassName = "null";
                    sOldString = "";
                    sNewClassName = "null";
                    sNewString = "";
                    ...
                    if (!td.getFieldDefinition(i).isID()) {
                        if (td.getFieldDefinition(i).isKey()) {
                            bKeyChanged = true;
                        } // Kulcs mezõ változott: ellenõrizni a leendõ rekordot duplikáltságra
            ...
            try {
                ...
                for (int i = 0; i
                    ...
                    if (!td.getFieldDefinition(i).isID()) {
                        ...
                        if ((oOld == null && oNew != null) || (oOld != null && oNew == null) || (oOld != null && oNew != null && !oOld.toString().equals(oNew.toString()))) { // Mezõ értéke megváltozott
                            ++iUpdateField;
                ...
                if (!bIDKey && bHasKey && bKeyChanged) {
                    ...
                    if (rs.next()) {
                        ...
                        rs.close();
                        appInterface.handleError("Létezõ rekordra nem lehet módosítani!");
                    } else {
                        ...
                        if (rs.next()) {
                            ...
                            appInterface.handleError("Nem létezõ rekord, nem lehet módosítani!");
                        }
        ...
        try {
            ...
            if (bHasKey) {
                ...
                if (rs.next()) {
                    ...
                    appInterface.handleError("Nem létezõ rekord, nem lehet törölni!");
                }

            } else {
                appInterface.handleError("Nincsenek kulcsmezõk, nem lehet törölni!");
            }
